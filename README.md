...
| 7 | [Zomato](https://github.com/Tiffany-Bergett/Data_projects_TripleTen/tree/main/Zuber) | The project task was to perform a "Customer Analysis Segmentation" via Power BI. |
