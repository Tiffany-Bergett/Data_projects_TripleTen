...
| 8 | [Zomato](https://github.com/Tiffany-Bergett/Data_projects_TripleTen/tree/main/Zomato) Feb2024 | A Customer Analysis Segmentation with RFM for Zomato restaurants via **Power BI**. |
